...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Amponsah Admin Panel</title>
             ...
             <div class="bg-black px-5 py-5">
              ...
              <ul class="list-reset text-white mt-8">
                        <li class="mb-1 hover:bg-blue-dark py-2">
                         ...
                         <li class="mb-1 hover:bg-blue-dark py-2">
                            <a href="{{route('arrival.index')}}" class="text-white pl-4 no-underline text-sm ">
                                <i class="fa fa-book mr-3"></i>
                                Book Category
                            </a>
                        </li>
                         <li class="mb-1 hover:bg-blue-dark py-2">
                            <a href="{{route('book.index')}}" class="text-white pl-4 no-underline text-sm ">
